...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        toLogin.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        toLogin.setText("Already have an account? login");
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        try {
            ...
            if(pass.length() < 8) {
                javax.swing.JOptionPane.showMessageDialog(null, "Password minimal 8 karakter!", "Peringatan", javax.swing.JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            String sqlCek = "SELECT * FROM users WHERE username = '" + user + "'";
            java.sql.Statement st = kon.createStatement();
            java.sql.ResultSet rs = st.executeQuery(sqlCek);
    
            if(rs.next()) {
                javax.swing.JOptionPane.showMessageDialog(null, "Username sudah digunakan!", "Peringatan", javax.swing.JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            javax.swing.JOptionPane.showMessageDialog(null, "Akun Berhasil Dibuat! Silahkan Login.");
    
            new Login().setVisible(true);
            this.dispose();
    
        } catch (Exception e) {
            javax.swing.JOptionPane.showMessageDialog(null, "Gagal Daftar: " + e.getMessage());
        }
